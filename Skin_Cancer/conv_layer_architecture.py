...
if __name__ == "__main__":   
    ...
    # ------------------------------------------------------------------------------------------
    conv_architecture = np.array([[1, 10, 64, 64, None, None, None],
                                  [10, 20, 64, 35, None, None, None],
                                  [20, 30, 35, 35, None, None, None],
                                  [30, 40, 35, 24, None, None, None],
                                  [40, 50, 20, 20,  None, None, None],
                                  [50, 60, 20, 16, None, None, None],
                                  [60, 70, 16, 16, None, None, None],
                                  [70, 80, 16, 12,  None, None, None],
                                  [80, 90, 12, 8,  None, None, None],
                                  [90, 100, 8, 8, None, None, None],
                                  [100, 100, 8, 8, None, 2, None]])
    # ------------------------------------------------------------------------------------------
